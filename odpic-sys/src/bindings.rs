...
pub const DPI_MINOR_VERSION: u32 = 5;
...
/// See [`dpiVectorFlags`]
pub const DPI_VECTOR_FLAGS_SPARSE: u8 = 2;
...
fn bindgen_test_layout_dpiVectorInfo() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).numSparseValues) as usize - ptr as usize },
        24usize,
        "Offset of field: dpiVectorInfo::numSparseValues"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).sparseIndices) as usize - ptr as usize },
        32usize,
        "Offset of field: dpiVectorInfo::sparseIndices"
    );
}
...
extern "C" {
    ...
    pub fn dpiData_getVector(data: *mut dpiData) -> *mut dpiVector;
}
extern "C" {
